...
<div class="max-w-md w-full space-y-6 bg-white p-8 rounded-xl shadow-lg text-center">
    <h1 class="text-3xl font-semibold text-gray-900">Subscription Confirmed</h1>
    <p class="text-gray-600">
        Thanks for subscribing! Your payment was successful and your subscription is now active.
    </p>
    <a href="{{ url('/') }}"
