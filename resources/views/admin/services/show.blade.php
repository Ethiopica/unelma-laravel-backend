<x-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @php
            $descriptionServiceNames = ['data management', 'data science', 'cloud service'];
            $isDescriptionService = in_array(strtolower($service->name), $descriptionServiceNames, true);
            $showPricingCards = strcasecmp($service->name, 'Cyber Security') === 0;
        @endphp
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="h-full">
                <div class="bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col">
                    ...
                    @else
                        <div class="flex-1 bg-white p-12 flex items-center justify-center">
                            <div class="text-center">
                                @if($service->icon)
                                    <div class="text-8xl mb-4">{{ $service->icon }}</div>
                                @else
                    ...
                    @if($isDescriptionService && $service->description)
                        <div class="border-t border-gray-200 p-6">
                            <h2 class="text-xl font-semibold text-gray-800 mb-3">Service Overview</h2>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                <!-- Business Plan -->
                <div class="bg-white rounded-lg shadow-lg border-2 border-gray-200 hover:border-blue-500 transition duration-200 overflow-hidden">
                ...
                <!-- Professional Plan -->
                <div class="bg-white rounded-lg shadow-lg border-2 border-purple-500 hover:border-purple-600 transition duration-200 overflow-hidden relative">
                    <div class="absolute top-0 right-0 bg-purple-600 text-white px-4 py-1 text-xs font-bold rounded-bl-lg">
                        POPULAR
                    </div>
