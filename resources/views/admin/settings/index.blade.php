                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('admin.users.index') }}"
                            class="block w-full bg-blue-50 hover:bg-blue-100 text-blue-700 px-4 py-2 rounded-lg transition duration-200 text-center">
                            Manage Users
                        </a>
                        <a href="{{ route('admin.reports.index') }}"
                            class="block w-full bg-green-50 hover:bg-green-100 text-green-700 px-4 py-2 rounded-lg transition duration-200 text-center">
                            View Reports
                        </a>
                        <a href="{{ route('admin.dashboard') }}"
                            class="block w-full bg-purple-50 hover:bg-purple-100 text-purple-700 px-4 py-2 rounded-lg transition duration-200 text-center">
                            Dashboard
                        </a>
                    </div>
                </div>
