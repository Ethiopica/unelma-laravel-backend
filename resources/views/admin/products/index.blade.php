        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="text-blue-600 font-semibold">Products</a>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-2">{{ $products->where('is_active', true)->count() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-2">{{ $products->where('is_featured', true)->count() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-2">{{ $products->where('is_active', false)->count() }}</p>
                        </div>
