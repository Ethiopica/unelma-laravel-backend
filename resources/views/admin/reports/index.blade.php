        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="text-blue-600 font-semibold">Reports</a>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-3">
                    @forelse($monthlyGrowth as $month)
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">{{ \Carbon\Carbon::parse($month->month . '-01')->format('F Y') }}</span>
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-bold text-gray-800 w-8 text-right">{{ $month->count }}</span>
                            </div>
                        </div>
                    @empty
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            {{ $userStats['total_users'] > 0 ? round(($userStats['users_with_pictures'] / $userStats['total_users']) * 100, 1) : 0 }}% of total users
                        </p>
                    </div>
