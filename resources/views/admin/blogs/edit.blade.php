<x-layout>
    <x-slot:title>Edit Blog Post - {{ config('app.name') }}</x-slot:title>
            ...
            <form method="POST" action="{{ route('admin.blogs.update', $blog->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="excerpt" name="excerpt" rows="3"
                        ...
                        placeholder="A brief summary of your blog post (max 500 characters)...">{{ old('excerpt', $blog->excerpt) }}</textarea>
                    @error('excerpt')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <textarea id="content" name="content" rows="15" required
                        ...
                        placeholder="Write your blog post content here... (HTML supported)">{{ old('content', $blog->content) }}</textarea>
                    @error('content')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="border-t pt-6 mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3"
                            ...
                            placeholder="Brief description for search engines (150-160 characters recommended)">{{ old('meta_description', $blog->meta_description) }}</textarea>
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ $blog->created_at->format('M d, Y \a\t h:i A') }}
                            </p>
                        </div>
                        <div>
                            <p class="text-gray-600">Last Updated:</p>
                            <p class="font-medium text-gray-900">{{ $blog->updated_at->format('M d, Y \a\t h:i A') }}
                            </p>
                        </div>
                        @if ($blog->published_at)
                            <div>
                                ...
                                <p class="font-medium text-gray-900">
                                    {{ $blog->published_at->format('M d, Y \a\t h:i A') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
