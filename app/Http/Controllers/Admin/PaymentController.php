...
class PaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $subscriptionRevenue = Subscription::whereIn('stripe_status', ['active', 'trialing'])
            ->whereNotNull('amount')
            ->sum('amount');
        $purchaseRevenue = Purchase::where('status', 'completed')->sum('amount');
